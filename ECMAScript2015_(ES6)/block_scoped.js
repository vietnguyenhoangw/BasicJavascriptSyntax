...
"use strict" // => write on top, using this to make the code safety
//Docs: https://freetuts.net/use-strict-la-gi-strict-mode-trong-javascript-407.html

// using (LET) to delare variable in ES6.
// 'let' using for declare a new variable, but it just have using in block.
// 'let' using when we want create a new var momentarily use
...
console.log("a: " + a);
console.log("b: " + b);
// console.log("tmp: " + tmp); 'tmp' just using in if.